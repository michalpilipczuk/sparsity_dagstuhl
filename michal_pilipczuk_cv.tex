...
\begin{small}
\noindent
\begin{tabular}{@{}p{2.7cm} @{\hspace{2mm}} p{15cm}}
...
\begin{small}
\noindent
\begin{tabular}{@{}p{3.8cm} @{\hspace{2mm}} p{13.7cm}}
since Oct 2017 & Researcher in ERC grant TOTAL ``Technology transfer between modern algorithmic paradigms'', led by Marek Cygan.\\[0.2cm]
...
\heading{Organization and invited participation in scientific events}
\begin{small}
\noindent
...
Mar 2016 & Lecturer at the ELC School on Parameterized Algorithms. Osaka, Japan.\\[0.1cm]
Apr 2015 & Lecturing a mini-course on parameterized complexity at Insitute of Informatics, University of Wrocław,~Poland.\\[0.1cm]
Aug 2014 & Organizer and lecturer at the International School on Parameterized Algorithms. Będlewo, Poland.
\end{tabular}
\end{small}


\heading{Scientific awards and stipends}
\begin{small}
\noindent
\begin{tabular}{@{}p{1.8cm} @{\hspace{2mm}} p{15.7cm}}
2018 & Zdzis\l{}aw Pawlak prize for the book {\em{Parameterized Algorithms}}.\\[0.1cm]
...
2016 & START stipend granted by the Foundation for Polish Science (FNP), awarded with a~distinguishment for the highest ranked applications.\\[0.1cm]
2015 & Witold Lipski Prize for the best young researchers working in computer science in Poland.\\[0.1cm]
2015 & Stipend of the Ministry of Science and Higher Education of the Republic of Poland for outstanding young researchers, awarded for three years.\\[0.1cm]
2015 & START stipend granted by the Foundation for Polish Science (FNP), awarded with a~distinguishment for the highest ranked applications.\\[0.1cm]
2014 & Nomination to International Banach Prize, an annual award for the best doctoral thesis in mathematical sciences.\\[0.1cm]
...
at the Lorentz Center workshop on Fixed-Parameter Computational Geometry. Leiden, the Netherlands.\\[0.1cm]
...
May 2016 & Invited talk {\em{Bidimensionality and beyond: parameterized algorithm design on planar graphs}} at the joint seminar ``Methods for Discrete Structures'' of Theoretical Computer Science research groups in Berlin. Berlin, Germany.\\[0.1cm]
Jan 2016 & Invited talk {\em{On tree-like graphs}} at the Polish Forum of Theoretical Computer Science (FIT 2016). Warsaw, Poland.\\[0.1cm]
...
Feb 2015 & Invited talk {\em{New results on computing tree decompositions of graphs}} at the ELC/B01 Workshop on Parameterized Algorithms. Tokyo, Japan.\\[0.1cm]
...
Sep 2012 & Invited tutorial {\em{Lower bounds for polynomial kernelization}} at the $7^{\textrm{th}}$ International Symposium on Parameterized and Exact Computation, IPEC 2012. Ljubljana, Slovenia.
\end{tabular}
\end{small}
\end{comment}
