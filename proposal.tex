...
\shorthandoff{-} % Incompatibility with czech package, amusingly.
\newpage
\includepdf[pages=-,pagecommand={\thispagestyle{plain}}]{dan_kral_cv}
\newpage
\includepdf[pages=-,pagecommand={\thispagestyle{plain}}]{seb_siebertz_cv}
\newpage
\includepdf[pages=-,pagecommand={\thispagestyle{plain}}]{michal_pilipczuk_cv}
\newpage
\includepdf[pages=-,pagecommand={\thispagestyle{plain}}]{blair_sullivan_cv}
\newpage
