...
Each of the above concepts is a tool: it offers a different combinatorial handle that can be used to look at a problem at hand from a different viewpoint.
